...
source("extern/counterfactuals/paper/experiments/law_school/generate_law_school.R")
source("extern/counterfactuals/paper/experiments/metrics.R")
SEED = 4321L
...
data = data.table(x)
fwrite(data, file = "extern/counterfactuals/paper/experiments/law_school/gen_data.csv")
